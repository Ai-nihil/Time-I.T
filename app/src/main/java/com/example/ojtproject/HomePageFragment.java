...
public class HomePageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        homePageFragmentButtonLogout = getActivity().findViewById(R.id.homePageFragmentButtonLogout);
        ...
        homePageFragmentTextClockActualClock = getActivity().findViewById(R.id.homePageFragmentTextClockActualClock);
        homePageFragmentTextClockActualDate = getActivity().findViewById(R.id.homePageFragmentTextClockActualDate);

        //Clock-In button logic starts here
        homePageFragmentButtonClockIn = getActivity().findViewById(R.id.homePageFragmentButtonClockIn);
